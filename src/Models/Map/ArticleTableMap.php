...
class ArticleTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Content', 'Description', 'UpdatedAt', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'content', 'description', 'updatedAt', 'createdAt', ),
        self::TYPE_COLNAME       => array(ArticleTableMap::COL_ID, ArticleTableMap::COL_TITLE, ArticleTableMap::COL_CONTENT, ArticleTableMap::COL_DESCRIPTION, ArticleTableMap::COL_UPDATED_AT, ArticleTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'content', 'description', 'updated_at', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Content' => 2, 'Description' => 3, 'UpdatedAt' => 4, 'CreatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'content' => 2, 'description' => 3, 'updatedAt' => 4, 'createdAt' => 5, ),
        self::TYPE_COLNAME       => array(ArticleTableMap::COL_ID => 0, ArticleTableMap::COL_TITLE => 1, ArticleTableMap::COL_CONTENT => 2, ArticleTableMap::COL_DESCRIPTION => 3, ArticleTableMap::COL_UPDATED_AT => 4, ArticleTableMap::COL_CREATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'content' => 2, 'description' => 3, 'updated_at' => 4, 'created_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    {
        return array(
            'timestampable' => array('create_column' => 'created_at', 'update_column' => 'updated_at', 'disable_created_at' => 'false', 'disable_updated_at' => 'false', 'created_at' => 'created_on', 'updated_at' => 'updated_on', ),
        );
    } // getBehaviors()
